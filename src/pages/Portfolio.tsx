...
const Portfolio = () => {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      description:
        "Professional corporate website that creates templates with custom CMS and responsive design across all devices.",
    },
    {
      title: "Elite Roofing",
    ...
    },
    {
      ...
      description:
        "A website showing various exchanges between crypto currencies",
    },
    {
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        <div ref={sectionRef} className="container mx-auto max-w-7xl">
          <div className="mb-12">
            <Link
              to="/"
              className="flex items-center space-x-2 text-space-purple-light hover:text-white transition-colors duration-300 mb-8"
            >
              <ArrowLeft size={20} />
            ...
            >
              Explore our collection of premium web development projects that
          ...
          <div className="animate-on-scroll" style={{ animationDelay: "0.8s" }}>
            ...
            <div className="flex items-center mb-8">
              <div className="flex items-center space-x-4">
                <button
                  onClick={prevSlide}
                  className="p-3 rounded-full border border-space-purple/30 text-space-purple hover:bg-space-purple/20 transition-colors duration-300"
                >
                  <ChevronLeft size={20} />
                </button>
                <button
        ...
        <div
          className="orbital-decoration w-40 h-40 top-20 left-10 opacity-10 -z-10"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="orbital-decoration w-28 h-28 bottom-20 right-20 opacity-15 -z-10"
