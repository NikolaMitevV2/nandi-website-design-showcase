      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center space-x-8">
            <a href="#home" className="font-lato font-light text-body hover:text-white transition-colors duration-300">
              Home
            </a>
            <a href="#portfolio" className="font-lato font-light text-body hover:text-white transition-colors duration-300">
              Our Work
            </a>
            <a href="#strengths" className="font-lato font-light text-body hover:text-white transition-colors duration-300">
              Why Us
            </a>
            <a href="#about" className="font-lato font-light text-body hover:text-white transition-colors duration-300">
              About
            </a>
            <a href="#contact" className="font-lato font-light text-body hover:text-white transition-colors duration-300">
              Contact
            </a>
          </div>
