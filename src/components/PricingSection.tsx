...
const PricingSection = () => {
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden">
          ...
          {plans.map((plan, index) => (
            <div 
              ...
              className={`animate-on-scroll card-hover p-8 rounded-3xl relative ${
                plan.recommended ? 'scale-105 border-2 border-space-purple' : ''
              }`}
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="font-lato font-light text-body mb-6 leading-relaxed">
                  {plan.description}
                </p>
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start space-x-3">
                    ...
                    <span className="font-lato font-light text-body">{feature}</span>
                  </li>
                ))}
              </ul>
      ...
      <div className="orbital-decoration w-36 h-36 top-20 right-10 opacity-10" style={{ animationDelay: '2s' }} />
      <div className="orbital-decoration w-24 h-24 bottom-32 left-20 opacity-15" style={{ animationDelay: '7s' }} />
    </section>
  );
};
