...
const StrengthsSection = () => {
  ...
  return (
    <section id="strengths" className="py-32 px-6 relative overflow-hidden">
      <div ref={sectionRef} className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {strengths.map((strength, index) => (
            <div 
              key={index}
              className="animate-on-scroll card-hover p-8 rounded-3xl text-center group"
      ...
      <div className="orbital-decoration w-36 h-36 top-20 left-10 opacity-10" style={{ animationDelay: '1s' }} />
      <div className="orbital-decoration w-24 h-24 bottom-32 right-20 opacity-15" style={{ animationDelay: '5s' }} />
    </section>
  );
};
