    ...
    <section className="py-32 relative overflow-hidden">
      <div ref={sectionRef} className="container mx-auto max-w-7xl px-6">
        {processSteps.map((step, index) => (
          <div 
            key={index}
            className="animate-on-scroll sticky top-20 mb-8 last:mb-0"
            style={{ 
            ...
            <div className="card-hover rounded-3xl overflow-hidden">
              <div className="grid lg:grid-cols-2 min-h-[600px]">
                ...
                <div className="p-12 lg:p-16 flex flex-col justify-center">
                  ...
                  <p className="font-lato font-light text-lg text-body leading-relaxed mb-8">
                    {step.description}
                  </p>
      ...
      <div className="orbital-decoration w-44 h-44 top-40 right-10 opacity-10" style={{ animationDelay: '2s' }} />
      <div className="orbital-decoration w-32 h-32 bottom-40 left-20 opacity-15" style={{ animationDelay: '6s' }} />
    </section>
  );
};
