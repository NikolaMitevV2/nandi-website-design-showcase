...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="font-montserrat font-bold text-6xl xs:text-7xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[9rem] text-white mb-6 tracking-tight">
          {" "}
          {/* Increased base text size significantly for mobile */}
          Websites
          <br />
