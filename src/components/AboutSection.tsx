  ...
  return <section id="about" className="py-32 px-6 relative overflow-hidden">
      <div ref={sectionRef} className="container mx-auto max-w-7xl">
        <div className="text-center mb-20">
          ...
          {/* Aesthetic Line */}
          <div className="animate-on-scroll flex justify-center mb-16" style={{
          animationDelay: '0.2s'
        }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          animationDelay: '0.3s'
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Web Development Process" className="w-full h-96 object-cover rounded-3xl shadow-2xl" />
      ...
      <div className="orbital-decoration w-28 h-28 bottom-20 left-20 opacity-15" style={{
      animationDelay: '3s'
    }} />
    </section>;
};
